...
def restricted(request):
    ...
    return render_to_response('tango/restricted.html', context_dict, context)

def about(request):
    context = RequestContext(request)
    return render_to_response('tango/about.html', {}, context)
...
def add_category(request):
    ...
    return render_to_response('tango/add_category.html', {'form': form}, context)
